      ...
      >
        ...
        >
          <path
            ...
            stroke="currentColor"
            strokeMiterlimit="10"
            d="M8.58,12.55c-.54,0-1.09.13-1.52.46-.82.64-1.14,1.58-.99,2.45l.39,2.36c.07.42-.32.78-.74.69-3.35-.72-5.13-2.81-5.23-6.16-.13-4.3,3.46-7.8,7.75-7.8h1.98c.22,0,.26-.05.26-.1V1.82c0-.73.59-1.32,1.32-1.32.31,0,.62.11.85.31l6.93,5.89c.56.48.95,1.17.92,1.91-.03.68-.33,1.28-.81,1.68l-7.04,5.98c-.56.47-1.39.4-1.86-.15-.2-.24-.31-.54-.31-.85v-2.62c0-.06-.05-.1-.1-.1h-1.81Z"
          />
        </svg>
      </button>
