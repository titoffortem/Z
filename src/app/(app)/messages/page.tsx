...
function TypingKeyboardIcon() {
  return (
    ...
    >
      <defs>
        <style>
          {`
            ...
            .typing-slide-right {
              animation: typingSlide 3s linear infinite;
            }

            .typing-roller {
              transform-origin: 386.985px 388.525px;
              animation: typingSpin 3s linear infinite;
            }

            @keyframes typingSlide {
              0% { transform: translateX(0); }
              100% { transform: translateX(2431.5px); }
            }
      ...
      <g className="typing-slide-right">
        <g transform="translate(0, 0)">
          <g className="typing-roller">
            <use href="#typing-logo-shape" />
          </g>
        </g>

        <g transform="translate(-2431.5, 0)">
          <g className="typing-roller">
            <use href="#typing-logo-shape" />
          </g>
        </g>
